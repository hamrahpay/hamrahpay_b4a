...
_statesfilename = anywheresoftware.b4a.keywords.Common.Application.getPackageName()+"state.dat";
...
if (true) return anywheresoftware.b4a.keywords.Common.True;
			...
			(_ba.processBA == null ? _ba : _ba.processBA).setLastException(e20); //BA.debugLineNum = 233;BA.debugLine="Log(\"Error loading state.\")";
